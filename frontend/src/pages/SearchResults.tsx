                            ...
                            <div className="glass-effect rounded-2xl p-6 sticky top-24">
                                ...
                                <div className="mb-6">
                                    ...
                                    <select
                                        ...
                                        className="input"
                                    >
                                        <option className="text-black" value="">{t('all_types')}</option>
                                        <option className="text-black" value="yacht">Yacht</option>
                                        <option className="text-black" value="sailboat">Sailboat</option>
                                        <option className="text-black" value="watercraft">Watercraft</option>
                                    </select>
                                </div>
                                                ...
                                                <div className="flex items-start justify-between mb-3">
                                                    <div>
                                                        ...
                                                        <p className="text-white/60 text-sm">
                                                            {embarcacion.longitud}ft • {embarcacion.capacidad} {t('guests')}
                                                        </p>
                                                    </div>
                                                    <div className="flex items-center gap-1">
                                                        ...
                                                        <span className="text-white font-semibold">{embarcacion.rating}</span>
                                                    </div>
                                                </div>
