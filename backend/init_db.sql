...
('Azimut Grande 27', 'yacht', 'super_yacht', 12, 88, 8500.00, 'Lujoso super yate con todas las comodidades. Perfecto para eventos corporativos y celebraciones especiales.', 'https://images.unsplash.com/photo-1569263979104-865ab7cd8d13?w=1200', 'disponible', TRUE, FALSE, 'French Riviera', 4.9),
('Sunseeker Predator', 'yacht', 'sport_yacht', 8, 68, 3200.00, 'Yate deportivo de alto rendimiento. Ideal para aventuras en el mar con estilo.', 'https://images.unsplash.com/photo-1605281317010-fe5ffe798166?w=1200', 'en_charter', FALSE, FALSE, 'Mykonos', 4.8),
('Lagoon Seventy 7', 'sailboat', 'catamaran', 12, 77, 6000.00, 'Catamarán de lujo con tripulación incluida. Experiencia de navegación incomparable.', 'https://images.unsplash.com/photo-1544551763-46a013bb70d5?w=1200', 'disponible', TRUE, TRUE, 'Caribbean', 5.0),
('SeaDoo Spark 1', 'watercraft', 'jet_ski', 2, 10, 350.00, 'Moto de agua moderna y ágil. Diversión garantizada en el agua.', 'https://images.unsplash.com/photo-1626297852194-a2f8c3a59e45?w=1200', 'mantenimiento', FALSE, FALSE, 'Miami Beach', 4.5),
('Ocean\'s Whisper', 'yacht', 'sport_yacht', 6, 50, 2800.00, 'Elegante yate deportivo para escapadas románticas o pequeños grupos.', 'https://images.unsplash.com/photo-1548119044-0baddaeccdd0?w=1200', 'disponible', FALSE, FALSE, 'Ibiza', 4.7),
('The Golden Horizon', 'yacht', 'super_yacht', 16, 65, 5600.00, 'Super yate con capitán incluido. Lujo y confort en alta mar.', 'https://images.unsplash.com/photo-1579737119782-411db103a3d2?w=1200', 'en_charter', TRUE, FALSE, 'Monaco', 4.9);
